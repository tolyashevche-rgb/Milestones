...
> **CURRENT BUILD: Stage 5 UA / P2.60.** Before running or auditing the product, read
...
> [the product-quality tracker](docs/product_quality_rebuild_tracker_ua.md); P2.60 is the
> current completed age-scope, route-prerequisite and data-rights step in that sequence.
...
├── prototype_stage5_ua/       ← CURRENT guided UA app (P2.60)
...
> Release **P2.60** is the current product baseline. The P2.16 material below is retained
