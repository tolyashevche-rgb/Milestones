...
> **CURRENT BUILD: Stage 5 UA / P2.53.** Before running or auditing the product, read
...
> [the product-quality tracker](docs/product_quality_rebuild_tracker_ua.md); P2.53 is the
> first completed safety step in that sequence.
...
├── prototype_stage5_ua/       ← CURRENT guided UA app (P2.53)
...
> Release **P2.53** is the current product baseline. The P2.16 material below is retained
